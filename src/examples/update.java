...
public class update extends Configured implements Tool, Mapper<LongWritable, GIS, LongWritable, GIS>, Reducer<LongWritable, GIS, LongWritable, GIS>
{
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new Configuration(), new hadoopGIS.examples.update(), args));
	}
}
